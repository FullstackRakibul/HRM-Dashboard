...
export const supportTicketMenu = [
  {
    ModuleId: 1,
    ...
    children: [
      ...
      {
        MenuId: 5,
        MenuName: "Support Monitoring",
        Key: 5,
        MenuPath: "ticket/supportMonitoring",
        isDelete: 1,
        isEdit: 1,
        isCreate: 1,
        isUpdate: 1,
  ...
  },
  {
    ...
    children: [
      ...
      {
        MenuId: 1,
        MenuName: "Raise issue via mail",
        Key: 1,
        MenuPath: "ticket/compose-issue-mail",
      },
    ],
  },
    ...
    children: [
      {
        ...
        Key: 2,
        MenuPath: "ticket/user-dashboard",
        isDelete: 1,
        isEdit: 1,
        isCreate: 1,
        isUpdate: 1,
