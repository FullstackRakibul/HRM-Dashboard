...
import { Input, Button, Upload, message, Col, Row, Card, Form } from "antd";
...
const TicketCreateForm = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // values.createdBy = EmpCode; // Assuming EmpCode is defined somewhere
        ...
        <Col span={12} className="">
          ...
          >
            <Form form={form} {...layout} labelAlign="left">
              <Form.Item label="Select Ticket Type" name="ticketTypeId">
                <TickeTypeDropDown
              ...
              <Form.Item label="Select Department" name="departmentId">
                <DepartmentDropDown
                  onDepartmentSelect={handleDepartmentSelect}
                />
              </Form.Item>
              <Form.Item label="Select Unit" name="unitId">
